...
//            System.out.println(Ax.isSelected() + " " + Vy.isSelected() + " " + Vz.isSelected() + " " + Tx.isSelected() + " " + My.isSelected() + " " + Mz.isSelected());
 ...
 //           System.out.println(Ax.isSelected() + " " + Vy.isSelected() + " " + Vz.isSelected() + " " + Tx.isSelected() + " " + My.isSelected() + " " + Mz.isSelected());
    ...
    public static Scene dataPanel() {
        ...
        width = new Label("" + mem.getXsec().Breadth + " mm");
        height = new Label("" + mem.getXsec().Height + " mm");
        mainR = new Label(" " + mem.getXsec().reBar.main_num + " \u03D5 " + (int)mem.getXsec().reBar.main_dia);
//        extraX = new Label(" " + mem.getXsec().reBar.extra_x_num + " \u03D5 " + (int)mem.getXsec().reBar.extra_x_dia);
//        extraY = new Label(" " + mem.getXsec().reBar.extra_y_num + " \u03D5 " +(int) mem.getXsec().reBar.extra_y_dia);
        shearSp = new Label(" \u03D58 c/c " + mem.getXsec().shearS + " mm");
        ...
        shearSpT.setFont(javafx.scene.text.Font.font("Aliquam", 20));
        shearSp.setFont(javafx.scene.text.Font.font("Aliquam", 20));
        ...
        shearSPP.setSpacing(20.0);
        shearSPP.getChildren().add(shearSpT);
        geometryN.getChildren().add(shearSp);
       ...
       geomet.getChildren().add(shearSPP);
...
// This method is invoked on the EDT thread
        ...
        mainR = new Label("" + m.getXsec().reBar.main_area);
//        extraX = new Label("" + m.getXsec().reBar.extra_x_area);
//        extraY = new Label("" + m.getXsec().reBar.extra_y_area);
